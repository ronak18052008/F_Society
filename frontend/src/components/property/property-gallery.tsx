  ...
  return (
    <div className="space-y-3">
      ...
      <div className="group relative h-[50vh] min-h-[380px] max-h-[560px] w-full overflow-hidden rounded-3xl border border-line bg-card shadow-card">
        ...
        <div className="absolute top-4 left-4 z-10 rounded-full bg-black/60 backdrop-blur-md px-3.5 py-1 text-xs font-semibold text-white/90 shadow-sm border border-white/10">
          <span>{active + 1}</span>
