    ...
    <RoleGuard allowedRole="tenant">
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        <Link
          ...
          className="group relative rounded-2xl border border-line bg-card p-5 shadow-card hover:shadow-card-hover hover:border-[var(--primary-pista)]/50 transition-all duration-200"
        >
          ...
          <p className="mt-2 text-xl font-serif font-bold text-ink group-hover:text-[var(--accent-forest)] transition-colors">
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <span className="rounded-full bg-[var(--primary-pista)]/15 px-2 py-0.5 text-[10px] font-bold text-[var(--accent-forest)]">
      ...
      <div className="mt-10">
        ...
        <div className="space-y-2.5">
          ...
          <div className="flex items-center justify-between rounded-xl border border-line bg-card px-4 py-3 shadow-xs">
            <div className="flex items-center gap-3">
              <span className="flex h-2 w-2 rounded-full bg-[var(--primary-pista)]" />
              <span className="text-xs sm:text-sm font-medium text-ink">
      ...
      <div className="mt-10 rounded-2xl border border-[var(--primary-pista)]/30 bg-gradient-to-r from-[var(--primary-pista)]/10 via-[var(--secondary-sage)]/5 to-transparent p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div>
