        ...
        >
          ...
          <div className="rounded-3xl border border-line bg-card p-6 sm:p-7 shadow-card space-y-6">
            <div className="flex items-center justify-between pb-3 border-b border-line">
              ...
              {parsedBudget > 0 ? (
                <span className="text-xs font-bold text-[var(--accent-forest)]">
                ...
                {[
                  ...
                  <button
                    ...
                    className={`flex flex-col items-center gap-1.5 rounded-2xl border p-4 text-center transition-all cursor-pointer ${
                      type === item.id
                        ? "border-[var(--primary-pista)] bg-[var(--primary-pista)]/10 text-[var(--text-main)] ring-2 ring-[var(--primary-pista)]/20 font-semibold"
